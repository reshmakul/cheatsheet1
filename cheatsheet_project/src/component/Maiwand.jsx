import styles from "../css/maiwand.module.css";

const Maiwand = () => {
  return (
    <div className={styles.main_maiwand} style={{ backgroundColor: "#506D7B" }}>
      <div className={styles.div_container}>
        <h1>React Router CheatSheet</h1>
      </div>
      <div className={styles.full_container}>
        <p className={styles.mainparagraph}>
          <div className={styles.title_main}>What is React Router?</div>
        </p>
        <p className={styles.mainparagraph}>
          ...
          <b>
            <li className={styles.list_num}>How to Install React Router</li>
          </b>
          <p className={styles.mainparagraph}>
      ...
      <div className={styles.full_container}>
        ...
        <img src="/01.png" className={styles.img_maiwand} />
      </div>
      <div className={styles.full_container}>
        ...
        <img src="/02.png" className={styles.img_maiwand} />
      </div>
      <div className={styles.full_container}>
        <p className={styles.mainparagraph}>
      ...
      <div className={styles.full_container}>
        ...
        <img src="/03.png" className={styles.img_maiwand} />
      </div>
      <div className={styles.full_container}>
        <p className={styles.mainparagraph}>
          Let’s now add Links to the NavBar this way:
        </p>
        <img src="/04.png" className={styles.img_maiwand} />
      </div>
      <div className={styles.full_container}>
        <p className={styles.mainparagraph}>
      ...
      <div className={styles.full_container}>
        ...
        <img src="/05.png" className={styles.img_maiwand} />
      </div>
      <div className={styles.full_container}>
        <p className={styles.mainparagraph}>
        ...
        <img src="06.png" className={styles.img_maiwand} />
      </div>
      ...
      <div className={styles.full_container}>
        ...
        <img src="/07.png" className={styles.img_maiwand} />
      </div>
      <div className={styles.full_container}>
        <p className={styles.mainparagraph}>
